...
abstract contract Governor is Context, ERC165, EIP712, IGovernor, IERC721Receiver, IERC1155Receiver {
    ...
    function hashProposal(
        ...
        return uint256(keccak256(abi.encode(titleHash, descriptionHash)));
    }
    ...
    function propose(
        ...
        uint256 proposalId = hashProposal(keccak256(bytes(title)), keccak256(bytes(description)));
    ...
    function execute(
        ...
        uint256 proposalId = hashProposal(titleHash, descriptionHash);
        ...
        _beforeExecute(proposalId, titleHash, descriptionHash);
        _execute(proposalId, titleHash, descriptionHash);
        _afterExecute(proposalId, titleHash, descriptionHash);
    ...
    function cancel(
        ...
        return _cancel(titleHash, descriptionHash);
    }
...
abstract contract GovernorCompatibilityBravo is IGovernorTimelock, IGovernorCompatibilityBravo, Governor {
    ...
    mapping(uint256 => mapping(uint8 => uint256) ) public totalVotesByType;
    ...
    function propose(
        string memory title,
        string memory description
    ) public virtual override(Governor, IGovernor, IGovernorCompatibilityBravo) returns (uint256) {
        ...
        _storeProposal(_msgSender(), title, description);
        return super.propose(title, description);
    }
    ...
    function queue(uint256 proposalId) public virtual override {
        ...
        queue(titleHash, descriptionHash);
    }
    ...
    function execute(uint256 proposalId) public payable virtual override {
        ...
        execute(titleHash, descriptionHash);
    }
    ...
    function cancel(uint256 proposalId) public virtual override {
        ...
        cancel(titleHash, descriptionHash);
    }
    ...
    function _getProposalParameters(
        ...
        private
        view
        returns (bytes32 titleHash, bytes32 descriptionHash)
    {
    ...
    function _countVote(
        ...
        if (support == uint8(VoteType.Against)) {
            ...
            totalVotesByType[proposalId][uint8(VoteType.Against)] += 1;
        } else if (support == uint8(VoteType.For)) {
            details.forVotes += weight;
            totalVotesByType[proposalId][uint8(VoteType.For)] += 1;
        } else if (support == uint8(VoteType.Abstain)) {
            details.abstainVotes += weight;
            totalVotesByType[proposalId][uint8(VoteType.Abstain)] += 1;
        } else {
...
contract TimelockController is AccessControl, IERC721Receiver, IERC1155Receiver {
    ...
    function hashOperation(
        ...
        return keccak256(abi.encode(titleHash, predecessor, salt));
    }
    ...
    function schedule(
        ...
        bytes32 id = hashOperation(titleHash, predecessor, salt);
        _schedule(id, delay);
        emit CallScheduled(id, titleHash, predecessor, delay);
        if (salt != bytes32(0)) {
    ...
    function scheduleBatch(
        ...
        bytes32 id = hashOperationBatch(titleHash, predecessor, salt);
        _schedule(id, delay);
            emit CallScheduled(id, titleHash, predecessor, delay);
        if (salt != bytes32(0)) {
            emit CallSalt(id, salt);
...
abstract contract GovernorTimelockControl is IGovernorTimelock, Governor {
    ...
    function queue(
        ...
        _timelockIds[proposalId] = _timelock.hashOperationBatch(titleHash, 0, descriptionHash);
        _timelock.scheduleBatch(titleHash, 0, descriptionHash, delay);
    ...
    function _execute(
        ...
        _timelock.executeBatch{value: msg.value}(titleHash, 0, descriptionHash);
    }
    ...
    function _cancel(
        ...
        uint256 proposalId = super._cancel(titleHash, descriptionHash);
    ...
    GovernorTimelockControl
{
    ...
    function cancel(
        ...
        return super.cancel(titleHash, descriptionHash);
    }

    function queue(
        bytes32 titleHash,
        bytes32 descriptionHash
    ) public override(GovernorTimelockControl, IGovernorTimelock) returns (uint256) {
        return super.queue(titleHash, descriptionHash);
    }
    ...
    function _execute(
        ...
        super._execute(proposalId, titleHash, descriptionHash);
    }
    ...
    function _cancel(
        ...
        return super._cancel(titleHash, descriptionHash);
    }
